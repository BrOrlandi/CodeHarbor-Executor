...
<div align="center">
  <img src="./images/dashboard-jobs.png" alt="CodeHarbor Dashboard" width="100%">
</div>
...
|----------|---------|-------------|
| `PORT` | `3000` | The port on which the service will run |
| `SECRET_KEY` | _(none)_ | Authentication token for API calls and dashboard login |
